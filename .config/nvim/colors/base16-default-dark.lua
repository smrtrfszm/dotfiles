...
local highlights = {
  ...
  ['@keyword.storage.lifetime'] = { fg = colors.cyan },
  ...
  ['@lsp.type.lifetime'] = { link = '@keyword.storage.lifetime' },
  ['@lsp.typemod.decorator.library.rust'] = { fg = colors.red },

  ['@module.haskell'] = { fg = colors.blue },
  ['@constructor.haskell'] = { fg = colors.blue },
  ['@string.special.proto'] = { link = 'String' },
